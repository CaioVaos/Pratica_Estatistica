...
# )
### Modificado ----
# https://github.com/Lchiffon/wordcloud2/issues/63
...
frequencia_palavras_2 <- frequencia_palavras%>%
  ...
  select(-c(3:4))
plot_nuvem_pandemica <- wordcloud3(
  data = frequencia_palavras_2,
  size = 0.6,          
  fontWeight = 'bold',  
  color= colorRampPalette(c("#c07068", "#ffffff"))(254), 
  backgroundColor="#2d2f45",
  shape="circle"
)
plot_nuvem_pandemica
# htmlwidgets::saveWidget(plot_nuvem_pandemica, "Avaliacao_6/media/plot_nuvem_pandemica.html", selfcontained = TRUE)

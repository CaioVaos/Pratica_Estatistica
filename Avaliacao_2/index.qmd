...
::: box-blue
Características do passageiro:

- <span style="font-size: 0.85em;"> Passageiros **mais velhos** → maior <span style="color: #2E7D32;">satisfação</span></span>
- <span style="font-size: 0.85em;"> Passageiros **mais jovens** → maior <span style="color: #C62828;">insatisfação</span>   </span>  

- Classe **executiva** → maior <span style="color: #2E7D32;">satisfação</span>  
- Classe **econômica** → maior <span style="color: #C62828;">insatisfação</span>     
:::
...
- **Viagens a negócios** → maior <span style="color: #2E7D32;">satisfação</span>
- **Viagens pessoais** → maior <span style="color: #C62828;">insatisfação</span>     

- **Sem atraso** → maior <span style="color: #2E7D32;">satisfação</span>
- **Com atraso** → maior <span style="color: #C62828;">insatisfação</span>   
:::

...
<div style="background:#e6f2fb; border:1.5px solid #1a6fa8; border-radius:12px; padding:1.25rem 1.1rem; display:flex; flex-direction:column; gap:10px; font-size:0.6em;">
<div style="display:flex; align-items:center; justify-content:left; gap:10px;">
...
<div style="background:#faf0e8; border:1.5px solid #b5622a; border-radius:12px; padding:1.25rem 1.1rem; display:flex; flex-direction:column; gap: 10px; font-size:0.6em;">
<div style="display:flex; align-items:center; justify-content:left; gap:10px;">
<h3 style="font-size:1.8em; font-weight:700; color:#0a2535; margin:0;">
...
<div style="margin-top:12px; background:#f2f2f0; border:1.5px solid #9a9a94; border-radius:12px; padding:0.75rem 1rem; font-size:0.6em;">
